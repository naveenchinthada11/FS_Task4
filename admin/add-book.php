...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        if ($book_id) {
            ...
            $result = addBook($title, $author, $category, $price, $description, $stock);
...
<head>
    ...
    <title><?php echo $book_id ? 'Edit' : 'Add'; ?> Book - Admin</title>
...
<body>
    ...
    <div class="admin-header">
        <div class="container">
            <h1><i class="bi bi-pencil-square"></i> <?php echo $book_id ? 'Edit Book' : 'Add New Book'; ?></h1>
        </div>
    </div>
        ...
        <div class="form-card">
            ...
            <form method="POST">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-control" name="category" required>
                        ...
                        <?php foreach ($categories as $cat): ?>
                            <option value="<?php echo $cat; ?>" <?php echo isset($book) && $book['category'] === $cat ? 'selected' : ''; ?>>
                                <?php echo $cat; ?>
                            </option>
                        <?php endforeach; ?>
                    </select>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" name="stock" value="<?php echo htmlspecialchars($book['stock'] ?? 0); ?>" required>
                </div>
                ...
                <button type="submit" class="btn-submit">
                    <?php echo $book_id ? 'Update Book' : 'Add Book'; ?>
                </button>
            </form>
        </div>
    </div>
